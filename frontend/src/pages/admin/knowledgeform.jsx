...
function KnowledgeForm() {
    ...
    let createknowledge = async (e) => {
      ...
      try {
        ...
        let knowledge = { title, description, about, writer }
        let res
        if (id) {
      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-lg">
        ...
        <form className="space-y-6" onSubmit={createknowledge}>
          <div>
            ...
            />
            {(errors && errors.title) && <p className="text-red-600 text-sm">{errors.title.msg}</p>}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
            ></textarea>
            {(errors && errors.description) && <p className="text-red-600 text-sm">{errors.description.msg}</p>}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
            ></textarea>
            {(errors && errors.about) && <p className="text-red-600 text-sm">{errors.about.msg}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none transition"
            />
            {(errors && errors.writer) && <p className="text-red-600 text-sm">{errors.writer.msg}</p>}
          </div>
          ...
          >
            {loading ? "Submitting..." : (id ? "Edit" : "Create")}
          </button>
        </form>
      </div>
    </div>
